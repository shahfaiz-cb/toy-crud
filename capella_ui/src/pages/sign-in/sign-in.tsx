            ...
            <Card className="w-full max-w-md shadow-xl border border-slate-200 backdrop-blur-sm rounded-md p-5">
                ...
                >
                    ...
                    <div className="flex items-center justify-center gap-3 pt-2 px-5">
                        ...
                        <Button type="submit" className="w-full" isDisabled={!isValid} isPending={login.isPending}>
                            Login
                            {
                                login.isPending ? (<Spinner color="current" size="sm"/>) : (<Check/>)
                            }
                        </Button>
                    </div>
                </Form>
                <Card.Footer className="text-sm text-slate-600 justify-center">
                    ...
                    <NavLink to={"/auth/sign-up"} className="ml-1 text-blue-500 font-medium cursor-pointer hover:underline">
                        Sign up
                    </NavLink>
                </Card.Footer>
            </Card>
